...
/**
 * Defines the interface for gift variations.
 */
interface GiftVariationInterface extends PurchasableEntityInterface, EntityChangedInterface, EntityOwnerInterface {

  /**
   * Gets the parent gift.
   *
   * @return GiftInterface|null
   *   The gift entity, or null.
   */
  public function getGift();

  /**
   * Gets the parent gift ID.
   *
   * @return int|null
   *   The gift ID, or null.
   */
   ...
   *   The field name.
   *
   * @return \Drupal\commerce_gift\Entity\GiftAttributeValueInterface|null
