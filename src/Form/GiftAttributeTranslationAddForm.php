...
/**
 * Provides the form for adding gift attribute translations.
 */
class GiftAttributeTranslationAddForm extends ConfigTranslationAddForm {
  ...
  /**
   * Constructs a new GiftAttributeTranslationAddForm object.
   *
