...
/**
 * Provides the form for editing gift attribute translations.
 */
class GiftAttributeTranslationEditForm extends ConfigTranslationEditForm {

  use GiftAttributeTranslationFormTrait;
  ...
  /**
   * Constructs a new GiftAttributeTranslationEditForm object.
   *
