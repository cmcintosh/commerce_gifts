...
namespace Drupal\commerce_gift\Element;
 ...
 *   '#type' => 'commerce_gift_rendered_attribute',
 ...
 * @endcode
 *
 * @FormElement("commerce_gift_rendered_attribute")
 */
class CommerceGiftRenderedAttribute extends Radios {
  ...
  public static function processRadios(&$element, FormStateInterface $form_state, &$complete_form) {
    if (count($element['#options']) > 0) {
      $storage = \Drupal::entityTypeManager()->getStorage('commerce_gift_attribute_value');
      $view_builder = \Drupal::entityTypeManager()->getViewBuilder('commerce_gift_attribute_value');
      ...
      foreach ($element['#options'] as $key => $choice) {
        ...
        if (isset($element['#default_value']) && $element['#default_value'] == $key) {
          $attributes['class'][] = 'gift--rendered-attribute__selected';
        }
    ...
    $element['#attached']['library'][] = 'commerce_gift/rendered-attributes';
    $element['#attributes']['class'][] = 'gift--rendered-attribute';
