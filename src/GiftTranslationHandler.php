...
/**
 * Defines the translation handler for gifts.
 *
 * Based on NodeTranslationHandler.
 */
class GiftTranslationHandler extends ContentTranslationHandler {
  ...
  public function entityFormAlter(array &$form, FormStateInterface $form_state, EntityInterface $entity) {
    ...
    if (isset($form['content_translation'])) {
      $form['content_translation'] += [
        '#group' => 'advanced',
        '#attributes' => [
          'class' => ['gift-translation-options'],
        ],
      ];
      $form['content_translation']['#weight'] = 100;
      // The basic gift values will be used, no need for specific elements.
