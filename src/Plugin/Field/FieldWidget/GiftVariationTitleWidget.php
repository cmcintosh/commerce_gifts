...
/**
 * Plugin implementation of the 'commerce_gift_variation_title' widget.
 *
 * @FieldWidget(
 *   id = "commerce_gift_variation_title",
 *   label = @Translation("Gift variation title"),
 *   field_types = {
 *     "entity_reference"
 *   }
 * )
 */
class GiftVariationTitleWidget extends GiftVariationWidgetBase implements ContainerFactoryPluginInterface {
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\commerce_gift\Entity\GiftVariationInterface[] $variations */
